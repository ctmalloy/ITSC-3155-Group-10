...
class Notepad:
    ...
    def openFile(self):
        ...
        if usb.exists():
            self.file = askopenfilename(initialdir="Notes", defaultextension=".txt",
    ...
    def newFile(self):
        result = messagebox.askyesnocancel("Save file?",
                                           "Save changes before closing? If you don't save any changes will be lost.")
        if result:
            self.saveFile()
        elif not result:
            self.root.title("Untitled - Notepad")
